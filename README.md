...
| **Facility Exposure** | `(Requested Loan Amount / FY2026 Revenue) * 100` | Ratio ≤ 1%: `0 pts penalty`<br>Ratio > 1% & ≤ 2%: `-3 pts penalty`<br>Ratio > 2% & ≤ 4%: `-7 pts penalty`<br>Ratio > 4% & ≤ 6%: `-11 pts penalty`<br>Ratio > 6%: `-16 pts penalty` |
